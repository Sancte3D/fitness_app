...
const PERSONA_SVG_INNER = {
  David:
    '<rect width="96" height="96" rx="22" fill="#000"/><g fill="none" stroke="#f5f5f5" stroke-width="8" stroke-linecap="butt" stroke-linejoin="miter"><line x1="28" y1="32" x2="28" y2="64"/><path d="M 38 32 A 16 16 0 0 1 38 64"/></g>',
  Michalis:
    '<rect width="96" height="96" rx="22" fill="#000"/><g fill="none" stroke="#f5f5f5" stroke-width="8" stroke-linecap="butt" stroke-linejoin="miter"><line x1="24" y1="32" x2="24" y2="64"/><line x1="36" y1="32" x2="48" y2="58"/><line x1="48" y1="62" x2="60" y2="32"/><line x1="72" y1="32" x2="72" y2="64"/></g>',
  Nico: '<rect width="96" height="96" rx="22" fill="#000"/>',
};

function headerPersonaSvgMarkup(user) {
  const inner = PERSONA_SVG_INNER[user] || PERSONA_SVG_INNER.David;
  return `<svg xmlns="http://www.w3.org/2000/svg" class="persona-header-icon" width="26" height="26" viewBox="0 0 96 96" role="presentation" aria-hidden="true" focusable="false">${inner}</svg>`;
}
const defaults = {
  pushGoal: 100,
  pushSets: 10,
...
function updatePersonaHeaderIcon() {
  const host = $("personaHeaderIcon");
  if (!host) return;
  host.innerHTML = headerPersonaSvgMarkup(activeUser || "David");
}
