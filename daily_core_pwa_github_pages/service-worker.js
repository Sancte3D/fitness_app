const CACHE_NAME="daily-core-v18";
const ASSETS=["./","./index.html","./app.js","./sync-config.js","./persona-david.svg","./persona-michalis.svg","./persona-nico.svg","./manifest.webmanifest","./icon-192.svg","./icon-512.svg"];
